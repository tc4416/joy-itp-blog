...
- Collective memory
-  media =/= memory? separate or conflate
- the infiltration of mass media in collective memory: Mandela Effect
- memory metaphor: memory use media  metaphor: flashbulb memory"...
- I wonder how ancient people recall memory when film/image media had yet to be invented
- "Do available media technologies dictate which sensory aspects of an event we inscribe in out memory, or do sensory perceptions dictate which medium we choose to record the experience?"
- "Recaptured attempt of self-presence"
- "memory is not mediated by media, but media and memory transform each other"
- "mutual shaping of memory and media"
- "Mediated memories are the activities and objects we produce and appropriate by means of media technologies, for creating and re-creating a sense of push, present, andfuture of ourselves in relation to others."
- ![[mediation.png]]
- "The commingling of both axes signals memories should be understood as processes—mediating self to culture to past to future."
- "Personal memory can only exist in relation to collective memory: in order to remember ourselves, we have to constantly align and juge the individual with the collective, but the sum of individual memories never equals collectivity."
